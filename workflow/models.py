...
class UdiFiaWorkflow(models.Model):
    change_number = models.CharField(max_length=50,null=True,blank=True)
    udr_fia_number = models.CharField(max_length=50,null=True,blank=True)
...
class Rule(models.Model):
    ...
    action_item = models.CharField(max_length=20,null=True,blank=True)
